  ...
  return (
    <div className="space-y-8 px-4 sm:px-6 lg:px-8 py-8">
      <div className="flex flex-col items-center text-center gap-2 mb-8">
        <h1 className="text-3xl sm:text-4xl font-bold tracking-tight">🌐 Comprehensive IT Tools</h1>
        <p className="text-base sm:text-lg text-muted-foreground max-w-2xl">
          List includes comprehensive technology stack and other important tools.
        </p>
      </div>
